...
Description: "A list of key population types"
* ^experimental = false
* ^compose.include.concept[0].code = $SCT#159799000
* ^compose.include.concept[0].display = "Sexually active with men"

* ^compose.include.concept[0].code = $SCT#159800001
* ^compose.include.concept[0].display = "Female prostitute"

* ^compose.include.concept[0].code = $SCT#228388006
* ^compose.include.concept[0].display = "Male prostitute"

* ^compose.include.concept[0].code = $SCT#417284009
* ^compose.include.concept[0].display = "Current drug user"

* ^compose.include.concept[0].code = $SCT#407375002
* ^compose.include.concept[0].display = "Surgically transgendered transsexual"
